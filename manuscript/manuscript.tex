...
$T_1 = \SI{5}{\second}$.
This $T_1$ value is based on bulk $^{31}$P NMR measurements
...
of the optimal efficiency.  This raises the question of why
...
Thus the 19\% figure likely understates the proximity of
