...
in Experiment~1d is a heuristic choice.  The tunnelling
transmission coefficient through a rectangular barrier is
energy-dependent but does not straightforwardly produce
Cauchy-distributed amplitudes.  The Cauchy distribution is
used here as a convenient heavy-tailed proxy; the key
qualitative finding---that heavy-tailed noise preserves
reservoir capacity better than Gaussian noise---does not
depend on the specific distributional form.
